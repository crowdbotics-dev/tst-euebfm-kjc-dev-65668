"""
Django settings for tst_euebfm_kjc_dev_65668 project.
...
ROOT_URLCONF = 'tst_euebfm_kjc_dev_65668.urls'
...
WSGI_APPLICATION = 'tst_euebfm_kjc_dev_65668.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_euebfm_kjc_dev_65668 API",
    "DESCRIPTION": "API documentation for tst_euebfm_kjc_dev_65668 App",
    "VERSION": "v1",
}
